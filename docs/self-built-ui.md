...
| Embedded browser annotation 覆盖层/工具条 | [#86](https://github.com/BubblePtr/PiGUI/issues/86) | S1 宿主与 surface、S2 标注层与 design mode 工具条均已落地(见上表 browser-surface);覆盖层在页内 Shadow DOM,不是 `shared/ui/` 组件。剩 S3 载荷回传([#151](https://github.com/BubblePtr/PiGUI/issues/151))与 S4 ADR-0029([#152](https://github.com/BubblePtr/PiGUI/issues/152)) |
