...
- `CONTRIBUTING.md`：已补，面向人类首次贡献者；规则仍以 `AGENTS.md` 为准。
- `CODE_OF_CONDUCT.md`、`SECURITY.md`、`.github/ISSUE_TEMPLATE/`、`.github/PULL_REQUEST_TEMPLATE.md`：已补。
...
4. **文档 PR**：`AGENTS.md`、`CONTEXT.md`、`docs/` 非 ADR 文件、`CONTRIBUTING.md`。已完成。
5. 发 `0.0.3` 作为改名后的首个版本（无外部用户，不升 MINOR），Release 说明里写明旧名与数据迁移行为。v0.0.2 升级实测降为建议项。
